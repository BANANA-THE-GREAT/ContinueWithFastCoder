...
class Reader:
    ...
    def search_for_sequences(
        ...
        return self.reader.search_for_sequences(
            py_substring=py_substring,
            k=k,
            choices=choices,
            long=long,
...
def process_results(
    results: typing.List[typing.List[int]],
    choices: typing.Optional[int] = None,
) -> typing.Tuple[typing.List[typing.List[int]], typing.List[typing.List[int]], typing.List[int], typing.List[int], typing.List[typing.List[int]]]:
    return draftretriever.process_results(
        results=results,
        choices=choices,
    )
