...
from zulipterminal.config.symbols import APPLICATION_TITLE_BAR_LINE, AUTOHIDE_TAB_RIGHT_ARROW, COLUMN_TITLE_BAR_LINE
...
from zulipterminal.ui_tools.views import MiddleColumnView, RightColumnView, TabView
...
class View(urwid.WidgetWrap):
    ...
    def left_column_view(self) -> Any:
        from zulipterminal.ui_tools.views import LeftColumnView
        from zulipterminal.config.symbols import AUTOHIDE_TAB_LEFT_ARROW
        tab = TabView(
