            ...
            for sample in tqdm(repo_dataset, total=len(repo_dataset)):
                ...
                with torch.inference_mode():
                    ...
                    for i in range(2000):
                        ...
                        candidates, tree_candidates, draft_buffers, from_datastore = generate_candidates_and_draft_buffer_using_cache(logits,input_ids,datastore,token_spans,cache_sequences,top_p,temperature,max_num_draft=num_draft,device=model.base_model.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # default="/home/shape_model/deepseek-coder-6.7b-instruct",
