    ...
    for topic in dataset:
        ...
        for repo in dataset[topic]:
            ...
            datastore = draftretriever.Reader(
                ...
                # index_file_path=f'/home/zhaoqianhui/REST/datastore/repo_ngram_datastore/{topic}/datastore_repo_ngram_{repo}.idx',
            ...
            for sample in tqdm(repo_dataset, total=len(repo_dataset)):
                ...
                #     # index_file_path=f'/home/zhaoqianhui/ADED/datastore/idiot_datastore/{namespace}.idx'
                # )
                # # # print("datastore loaded!")
