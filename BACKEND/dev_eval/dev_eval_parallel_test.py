...
def run_eval(model, tokenizer, max_token_span, num_draft, temperature, top_p, max_new_token):
    ...
    stack_datastore = draftretriever.Reader(
                ...
                # index_file_path='/home/jiaoziqian/LLMAcceleration-REST/datastore/datastore_stack_large_deepseek.idx',
                # index_file_path=f'/home/jiaoziqian/LLMAcceleration-REST/datastore/repo_datastore/{topic}/datastore_repo_{repo}.idx',
                # index_file_path=f'/home/jiaoziqian/LLMAcceleration-REST/datastore/repo_identifier_datastore/{topic}/datastore_repo_identifier_{repo}.idx',
                # index_file_path=f'/home/jiaoziqian/LLMAcceleration-REST/datastore/repo_ngram_datastore/{topic}/datastore_repo_ngram_{repo}.idx',
            )
        ...
        for repo in dataset[topic]:
            ...
            for sample in tqdm(repo_dataset, total=len(repo_dataset)):
                ...
                with torch.inference_mode():
                    ...
                    for i in range(2000):
                        candidates, tree_candidates, draft_buffers = generate_candidates_and_draft_buffer_for_datastores_parallel(
                                logits,
                                input_ids,
                                datastores,
                                token_spans,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # default="/home/jiaoziqian/LLMAcceleration-REST/dev_eval/data/dev_eval_trunc.jsonl",
